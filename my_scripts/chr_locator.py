...
"""Takes SJ sequence and chromosome information and accesses
NCBI to generate a valid ID for later use."""

import re
import requests

MM_DICT = {'chr1':'NC_000067.7','chr2':'NC_000068.8','chr3':'NC_000069.7',
    ...
    for idx, line in enumerate(f.readlines()):
        ...
        with open("test_output.txt","r") as g:
            for b_line in g.readlines():
                ...
                if new_gene:
                    the_gene = re.search(r'(/gene=\")(.+)\"',b_line)
